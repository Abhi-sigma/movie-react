...
namespace ServiceLayer.Migrations
{
    ...
    [Migration("20210126074549_addedtagstable")]
            ...
            modelBuilder.Entity("ServiceLayer.Model.Actor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ActorId = 1,
                            ActorTypeId = 1,
                            InsertedDate = new DateTime(2021, 1, 26, 18, 45, 48, 663, DateTimeKind.Local).AddTicks(7551),
                            Name = "Allu Arjun"
                        },
                        new
                        {
                            ActorId = 2,
                            ActorTypeId = 1,
                            InsertedDate = new DateTime(2021, 1, 26, 18, 45, 48, 668, DateTimeKind.Local).AddTicks(4752),
                            Name = "Ravi Teja"
                        },
                        new
                        {
                            ActorId = 3,
                            ActorTypeId = 1,
                            InsertedDate = new DateTime(2021, 1, 26, 18, 45, 48, 668, DateTimeKind.Local).AddTicks(4814),
                            Name = "Shree Ram"
                        },
                        new
                        {
                            ActorId = 4,
                            ActorTypeId = 1,
                            InsertedDate = new DateTime(2021, 1, 26, 18, 45, 48, 668, DateTimeKind.Local).AddTicks(4821),
                            Name = "Jnr Ntr"
                        });
                });
