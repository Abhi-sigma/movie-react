...
namespace ServiceLayer.Migrations
{
    ...
    [Migration("20200818114238_changed_movie_table")]
    partial class changed_movie_table
    {
            ...
            modelBuilder.Entity("ServiceLayer.Model.Actor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ActorId = 1,
                            ActorTypeId = 1,
                            InsertedDate = new DateTime(2020, 8, 18, 21, 42, 37, 600, DateTimeKind.Local).AddTicks(1088),
                            Name = "Allu Arjun"
                        },
                        new
                        {
                            ActorId = 2,
                            ActorTypeId = 1,
                            InsertedDate = new DateTime(2020, 8, 18, 21, 42, 37, 604, DateTimeKind.Local).AddTicks(3320),
                            Name = "Ravi Teja"
                        },
                        new
                        {
                            ActorId = 3,
                            ActorTypeId = 1,
                            InsertedDate = new DateTime(2020, 8, 18, 21, 42, 37, 604, DateTimeKind.Local).AddTicks(3523),
                            Name = "Shree Ram"
                        },
                        new
                        {
                            ActorId = 4,
                            ActorTypeId = 1,
                            InsertedDate = new DateTime(2020, 8, 18, 21, 42, 37, 604, DateTimeKind.Local).AddTicks(3531),
                            Name = "Jnr Ntr"
                        });
                });
            ...
            modelBuilder.Entity("ServiceLayer.Model.Movies", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Released = new DateTime(2020, 8, 18, 21, 42, 37, 604, DateTimeKind.Local).AddTicks(6777),
                            Title = "Kalyanam",
                            imdbId = 0,
                            imdbrating = 4
                        });
